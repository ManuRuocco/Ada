...
\begin{figure} [H]
	...
	\addplot [black,mark=*] coordinates {(1.76244, 500000)};
	\addplot [black,mark=*] coordinates {(1.76244, 1000000)};
	\addplot [black,mark=*] coordinates {(1.76244, 10000000)};
	...
	\node at (axis cs: 1.4, 20000000) { \scriptsize \underline{STALL BOUNDARIES}};
	\node at (axis cs: 2.1, 2500000) { \scriptsize STALL};
\draw[line width=0.5pt]  (axis cs: 1.35, 19000000) -- (axis cs: 0.86198777 ,	1.0927104E7);
\draw[line width=0.5pt] (axis cs: 1.45, 19000000) -- (axis cs: 1.2730561,	1.0039192E7);
\draw[line width=0.5pt, dashed] (axis cs: 1.76244, 300000) -- (axis cs: 1.76244,	10000000);
\draw[line width=0.5pt, dashed] (axis cs: 0.3, 500000) -- (axis cs: 1.76244,	500000);
\draw[line width=0.5pt, dashed] (axis cs: 0.3, 1000000) -- (axis cs: 1.76244,	1000000);
\draw[line width=0.5pt, dashed] (axis cs: 0.3, 10000000) -- (axis cs: 1.76244,	10000000);
	\end{semilogyaxis}
	\end{tikzpicture}
\caption{\footnotesize Criterio di Thain e Gault, risultati per il profilo PW106}
	\label{fig:tin}
