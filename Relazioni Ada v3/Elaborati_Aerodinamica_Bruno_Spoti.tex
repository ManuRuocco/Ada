...
\usepackage{wrapfig}
\usepackage{lipsum}
\usepackage[nouppercase, swapnames, norules]{frontespizio}
...
%\input{Capitoli/Parte_3-Aerodinamica_Velivolo_A340-200/carico_alare}

\input{Capitoli/Teoria_globale_velivolo}
%\input{Capitoli/carico}
%\input{stallo}
